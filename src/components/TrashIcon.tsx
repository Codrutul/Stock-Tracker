export default function TrashIcon() {
    return (
        <svg
            ...
            viewBox="0 0 16 16"
            fill="#000000"
            className="bi bi-trash cursor-pointer trash-icon transition-colors duration-300 ease-in-out"
            width="30"
            height="30"
        >
          ...
          .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z"/>
                <path fillRule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2
          2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1
          1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1
          1h3.5a1 1 0 0 1 1 1v1zM4.118 4 4
